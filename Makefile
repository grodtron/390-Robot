...
SRCS    := driver.c line_sensors_main.c motors_main.c motors.c line_sensors.c event_queue.c iodefs.c movement_manager.c ring_robot_main.c switch_direction.c
